...
#define PUBLISH_IMU 1
#define IMU_PUBLISH_RATE 30 //hz
#define PUBLISH_IRSWITCH 0
#define IR_SWITCH_PUBLISH_RATE 50 //hz
#define PUBLISH_ULTRASONICS 1
#define ULTRASONICS_PUBLISH_RATE 100 //hz
...
#define COUNTS_PER_REV 3930       // wheel encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.08       // wheel's diameter in meters
#define PWM_BITS 8                // PWM Resolution of the microcontroller
#define LR_WHEELS_DISTANCE 0.290  // distance between left and right wheels
#define FR_WHEELS_DISTANCE 0.305   // distance between front and rear wheels. Ignore this if you're on 2WD/ACKERMANN
...
/// ULTRASONIC PINS
#define LEFT_TRIGGER 22
#define LEFT_ECHO 4

#define CENTER_TRIGGER 21
